...
export default async function LegacyPage() {
  ...
  return (
    <>
      ...
      <a href="/" style={{ ...floatingLink, bottom: 266 }}>新版工作台</a>
      <a href="/routes/today" style={{ ...floatingLink, bottom: 206 }}>今日路線</a>
      <a href="/journal" style={{ ...floatingLink, bottom: 146 }}>處理日誌</a>
      <a href="/adjustment" style={{ ...floatingLink, bottom: 86 }}>改單 ODS</a>
      <a href="/import" style={{ ...floatingLink, bottom: 26 }}>批次匯入</a>
    </>
  );
}
